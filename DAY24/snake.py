...
class Snake:
    ...
    # Function to re-create the snake whenever the player touches the wall or the own snake itself
    def reset_snake(self):
        for block in self.blocks:
            # we are sending the snake to the (1000, 1000) position, since our screen is of only 600*600 size
